...
export const sellers = {
  ...
  addWorkCard: (payload: FormData) => api.post('/sellers/profile/gallery/', payload, { headers: { 'Content-Type': 'multipart/form-data' } }),
  removeWorkCard: (id: number) => api.delete(`/sellers/profile/gallery/${id}/`),
